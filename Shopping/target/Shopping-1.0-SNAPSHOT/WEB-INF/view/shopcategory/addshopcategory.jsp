...
<div class="page-container">
    <form  id="addshopcategory" class="form form-horizontal"action="/" method="POST">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 商铺分类ID：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text"  id="shopcutId" name="shopcutId"  >
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 商铺分类名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text"  id="shopcut" name="shopcut"  >
            </div>
        </div>
<%--        <div class="row cl">--%>
<%--            <label class="form-label col-xs-4 col-sm-2">上级商铺分类Id：</label>--%>
<%--            <div class="formControls col-xs-8 col-sm-9">--%>
<%--                <select name="upshopcutId" id="upshopcutId" class="input-text"value="">--%>
<%--                    <c:forEach items="${shopcut}" var="shopcategory">--%>
<%--                        <option value="${shopcategory.shopcutId}">--%>
...
<%--        </div>--%>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text"  id="shopcutDescribe" name="shopcutDescribe"  >
            </div>
        </div>
        <div class="row cl">
    ...
    var mysubmit = function(){
        if (checkData()){
            var data= {
                ...
                shopcut: $("input[name='shopcut']").val(),
            ...
            $.ajax({
                type: "POST",
                url: "/Shopping/shop/addshopcategory",
                // dataType:"json",
