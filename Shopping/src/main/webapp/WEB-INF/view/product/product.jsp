...
<div class="page-container">
    ...
    <div>
        ...
        <input type="text" name="" id="proRange" placeholder="商品特色" style="width:120px" class="input-text"><br/>
        <select name="" id="states" placeholder="状态" style="width:120px" class="input-text">

            <option value="0">上架</option>
            <option value="1">下架</option>
        </select>
        <select name="" id="introduction" placeholder="是否推荐" style="width:120px" class="input-text">
...
<script type="text/javascript">
    ...
    var getParamsUrl = function(){
        ...
        var proRange=$("#proRange").val();
        var states=$("#states").val();
        var introduction=$("#introduction").val();
        console.log(this);
        return url+"?proId="+proId+"&cut="+cut+"&proName="+proName+"&proRange="+proRange+"&states="+states+"&introduction="+introduction;
    }
    var table;
