    ...
    <form class="form form-horizontal"id="useredit" method="POST" action="/">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" id="userId" class="input-text"value=${adminmessage.userId}><!-- adminmessage对应的是controller里的对象名称 -->
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户名:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" id="userName"class="input-text" value=${adminmessage.userName}>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>性别:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <select id="sex" value=${adminmessage.sex}>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" id="password"class="input-text" value=${adminmessage.password}>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> TEL：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text"  id="tel" name="tel" value=${adminmessage.tel}>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>状态:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <select id="state" value=${adminmessage.state}>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text"   id="address" name="address" value=${adminmessage.address} >
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>部门：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <select  id="depName" class="input-text"value=${adminmessage.depName}>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text Wdate" onfocus="WdatePicker({skin:'whyGreen',maxDate:'%y-%M-%d'})" id="registerTime" name="registerTime" value=${adminmessage.registerTime} >
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    var checkData = function(){
            var userId1='${adminmessage.userId}';
    ...
    var submit = function(){
        if (checkData()){
            ...
            $.ajax({
                type: "POST",
                url: "/Shopping/admin/adminsubmitEdit",
                /* dataType:"json", */
