...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="/Shopping/usermessage/revertAllUsers" data-title="用户管理" href="javascript:void(0)">用户管理</a></li>
        ...
        <dl id="menu-department">
            ...
            <dd>
                <ul>
                    <li><a data-href="/Shopping/department/revertAllDep" data-title="部门管理" href="javascript:void(0)">部门管理</a></li>
        ...
        <dl id="menu-shorp">
            ...
            <dd>
                <ul>
                    <li><a data-href="/Shopping/shop/revertAllShops" data-title="店铺管理" href="javascript:void(0)">店铺管理</a></li>

                </ul>
                <ul>
                    <li><a data-href="/Shopping/product/revertAllproducts" data-title="商品管理" href="javascript:void(0)">商品管理</a></li>

                </ul>
                <ul>
                    <li><a data-href="/Shopping/order/revertAllorders" data-title="订单管理" href="javascript:void(0)">订单管理</a></li>
