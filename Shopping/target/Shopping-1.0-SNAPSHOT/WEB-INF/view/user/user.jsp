...
<div class="page-container">
    <div class="text-c"> 查询条件：
        ...
        <select name="sex" id="sex" placeholder="性别" style="width:120px" class="input-text">
...
<script type="text/javascript">
    var url = "/Shopping/user/getList";
    var getParamsUrl = function(){
        var userId=$("#userId").val();
        var userName=$("#userName").val();
        var sex=$("#sex").val();
        var myurl= url+"?userId="+userId+"&userName="+userName+"&sex="+sex;
        return myurl;
    }
    var table;
    function user_query(){
    ...
    function user_edit(id){
        var title="用户编辑";
        var url="/Shopping/user/edituser";
