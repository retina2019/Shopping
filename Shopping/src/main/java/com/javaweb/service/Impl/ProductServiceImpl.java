...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<Product> searchByProId(String proId) throws Exception{
        // TODO Auto-generated method stub
        System.out.println("searchByProId:"+proId);
        List<Product> product = productMapper.searchByProId(proId);
        return product;
    }
    @Override
